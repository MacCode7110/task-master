...
const Page: React.FC<ManageBoardProps> = ({ manager }) => {
    ...
    return (
        <div className="section">
            ...
            <h2 className = "title is-5 has-text-weight-bold is-family-sans-serif has-text-warning-dark" data-testid="totalEstimatedUnassigned">Total Number of Estimated Minutes for all Unassigned Tasks: {totalEstimatedUnassignedTime}</h2>
            <h3 className = "title is-5 has-text-weight-bold is-family-sans-serif has-text-warning-dark" data-testid="totalCompleted">Total Number of Minutes for all Completed Tasks: {totalCompletedTime}</h3>
